...
- `ifcopenshell>=0.8` (IFC B-rep extraction and semantic mapping)
...
def normalize_coordinates(
    ...
    if extent > max_extent:
        ...
        scale = 1.0
    return translated, np.array([centroid, scale])
...
def process_geometry_pipeline(
    ...
    try:
        norm_verts, transform = normalize_coordinates(raw_vertices)
