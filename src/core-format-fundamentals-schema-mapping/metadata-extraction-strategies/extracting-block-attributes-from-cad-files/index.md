---
title: "Extracting block attributes from CAD files"
description: "Extracting block attributes from CAD files is a foundational step in automating AEC data workflows. In DXF and DWG formats, block attributes are stored as…"
---
